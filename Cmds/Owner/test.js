module.exports = async (context) => {
  ...
  const url = 'https://github.com/BLACKY-X-MD/CYBER-DINU-MD-V1';
  const murl = 'https://whatsapp.com/channel/0029Vb3n3T5HltYC47zpGs2N';
  const img = 'https://i.ibb.co/dJPR3mss/4fee3389898c57cf.jpg';
  ...
  const doc = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        title: '𝗜 𝗔𝗠 𝗔𝗟𝗜𝗩𝗘 𝗠𝗢𝗧𝗛𝗘𝗥 𝗙𝗨𝗖𝗞𝗘𝗥 😹. 𝗠𝗬 𝗡𝗔𝗠𝗘 𝗜𝗦....🥲👋',
        body: 'CYBER DINU ID',
        thumbnailUrl: img,
        sourceUrl: murl,
        mediaType: 1,
